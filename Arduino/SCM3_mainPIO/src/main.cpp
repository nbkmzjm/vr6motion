...
Sabertooth ST[2] = {
    Sabertooth(128, mySerial),
    Sabertooth(129, mySerial),
};
...
const int limitUp1 = 7;
const int limitDown1 = 6;
const int limitUp2 = 5;
const int limitDown2 = 4;
const int ledPin = 2;
int limitUpState1 = 0;
...
void loop()
{
    ...
    while (1 == 1)
    {
        ...
        if (PIDProcessCounter >= PIDProcessDivider)
        {
            ...
            if ((Feedback3 > CutoffLimitMax3) || (Feedback3 < CutoffLimitMin3))
            {
                DisableMotor3();
            }
