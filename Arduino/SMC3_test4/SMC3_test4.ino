...
const int ENBpin3 =A3;          // ENB output pin for Motor H-Bridge 3 (ie PortD bit position)
...
int limitUpState1 = 0; 
int limitDownState1 = 0; 
int limitUpState2 = 0; 
int limitDownState2 = 0;
int motorOut1 = 0;
int deltaPos = 0;
int accumDeltaPos = 0;
...
//  encoderLastState1 = digitalRead(encoder1A);  
  ...
  pinMode(limitUp1, INPUT);
  pinMode(limitDown1, INPUT);
  pinMode(limitUp2, INPUT);
  pinMode(limitDown2, INPUT);
  digitalWrite(limitUp1, HIGH);
  digitalWrite(limitDown1, HIGH);
...
//                    default:
        ...
        case 'D':
            ...
            // int num = 64;
            // Serial.print("{");
            // Serial.print(String(RxBuffer[1][ComPort]*256));
            // Serial.print("-");
            // Serial.print(String(RxBuffer[2][ComPort]*256));
            // Serial.print("}");
...
void SetOutputsMotor1()     // MODE3
{
   ...
   {
       PWMout1 = PWMrev1;
       K1.s(-(constrain((PWMout1*3),-750,750)));
   }
   else if((Feedback1<InputClipMin1) && (PWMrev1 != 0))
   {
       PWMout1 = PWMrev1;
...
void SetOutputsMotor2()     // MODE3
{
   ...
   {
       PWMout2 = PWMrev2;
       K2.s(-(constrain((PWMout2*3),-750,750)));
   }
   else if((Feedback2<InputClipMin2) && (PWMrev2 != 0))
   {
       PWMout2 = PWMrev2;
   ...
   mySerial.write('o');
    ...
    while (1==1) 
    {
        ...
        PIDProcessCounter=0;
            ...
            if(Feedback1 < -10 || Feedback1 > 1024 ){
              digitalWrite(ledPin, HIGH);
              K1.powerDown();
              
            }else if (Feedback1 - PreFeedback1 > 40){
             digitalWrite(ledPin, HIGH);
             K1.powerDown();
...
//              ST[0].setTimeout(500);
            ...
            if(Feedback2 < -10 || Feedback2 > 1024 ){
              digitalWrite(ledPin, HIGH);
              K2.powerDown();
              
            }else if (Feedback2 - PreFeedback2 > 40){
             digitalWrite(ledPin, HIGH);
             K2.powerDown();
